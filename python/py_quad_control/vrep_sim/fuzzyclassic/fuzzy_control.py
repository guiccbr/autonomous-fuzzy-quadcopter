...
class fuzzyController:
    ...
    def __init__(self, ranges, defuzRanges, membershipNumber=5.0, variance=[5.0,0.003]):
        self._ranges=ranges
        ...
        for input_ in inputs:
            ...
            for mean in membershipsMean:
                ...
                if mean==rangeInput[1] and input_ > mean:
                    subAlpha.append(1.0)
                    continue
                subAlpha.append(exp((-(input_-mean)**2)/(2*self._variance[i]**2)))
